...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'element-ui-wh/src/utils/date-util';
  import ElScrollbar from 'element-ui-wh/packages/scrollbar';
  import RepeatClick from 'element-ui-wh/src/directives/repeat-click';
