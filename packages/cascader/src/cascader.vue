...
<script>
import Popper from 'element-ui-wh/src/utils/vue-popper';
import Clickoutside from 'element-ui-wh/src/utils/clickoutside';
import Emitter from 'element-ui-wh/src/mixins/emitter';
import Locale from 'element-ui-wh/src/mixins/locale';
import Migrating from 'element-ui-wh/src/mixins/migrating';
import ElInput from 'element-ui-wh/packages/input';
import ElTag from 'element-ui-wh/packages/tag';
import ElScrollbar from 'element-ui-wh/packages/scrollbar';
import ElCascaderPanel from 'element-ui-wh/packages/cascader-panel';
import AriaUtils from 'element-ui-wh/src/utils/aria-utils';
import { t } from 'element-ui-wh/src/locale';
import { isEqual, isEmpty, kebabCase } from 'element-ui-wh/src/utils/util';
import { isUndefined, isFunction } from 'element-ui-wh/src/utils/types';
import { isDef } from 'element-ui-wh/src/utils/shared';
import { addResizeListener, removeResizeListener } from 'element-ui-wh/src/utils/resize-event';
